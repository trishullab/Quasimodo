...
do
    ...
    do
        ...
        for j in "${options[@]}";
        do
            echo "python3 simons2.py $numQubits $j $c >> simons2_${j}_${numQubits}.txt"
            timeout -v 15m python3 simons2.py $numQubits $j $c >> simons2_${j}_${numQubits}.txt
        done
    done
done
...
do
    ...
    do
        ...
        do
            ...
            timeout -v 15m python3 qft.py $numQubits $j $c >> qft_${j}_${numQubits}.txt
        done
    done
done
...
do
    ...
    do
        ...
        do
            ...
            timeout -v 15m python3 grovers.py $numQubits $j $c >> grovers_${j}_${numQubits}.txt
        done
    done
done
