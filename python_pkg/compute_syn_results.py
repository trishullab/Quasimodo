...
def output_avg_time(inp_folder, out_folder):
    ...
    benchmarks = ['test1', 'test2', 'test3', 'test4', 'test5']
    values = {'test1': OrderedDict(), 'test2':OrderedDict(), 'test3':OrderedDict(), 'test4':OrderedDict(), 'test5':OrderedDict() }
    mem_vals = {'test1': OrderedDict(), 'test2':OrderedDict(), 'test3':OrderedDict(), 'test4':OrderedDict(), 'test5':OrderedDict() }
            ...
            with open(inp_folder + "/" + filename, "r") as inp:
                ...
                for line in inp.readlines():
                    if "Duration" in line:
                        ...
                        time_taken = time_taken + float(tokens[1])
                        memory = memory + int(tokens[3])
                        count = count + 1
