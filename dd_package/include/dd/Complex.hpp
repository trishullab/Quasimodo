...
namespace dd {
    ...
    struct Complex {
        ...
        static Complex min_one;  // NOLINT(readability-identifier-naming,cppcoreguidelines-avoid-non-const-global-variables) automatic renaming does not work reliably, so skip linting
        static Complex min_sqrt_2;  // NOLINT(readability-identifier-naming,cppcoreguidelines-avoid-non-const-global-variables) automatic renaming does not work reliably, so skip linting
    ...
    inline Complex Complex::min_one{&ComplexTable<>::min_one, &ComplexTable<>::zero};   // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
    inline Complex Complex::min_sqrt_2{&ComplexTable<>::min_sqrt_2, &ComplexTable<>::zero};   // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
} // namespace dd
