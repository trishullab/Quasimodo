...
namespace dd {
    ...
    constexpr ComplexValue minus_complex_1plusi_2  = {-0.5,- 0.5};
    ...
    constexpr GateMatrix SYmat{complex_1plusi_2, minus_complex_1plusi_2, complex_1plusi_2, complex_1plusi_2};
